...
Selenide.sleep(10000);
    ...
    @Дано("параметры банка")
    public void параметры_банка() {
        driver.findElementByXPath("/html/body/div[2]/div[1]/div/form/div[2]/div[1]/div/ul[1]/ul/li[1]/input").sendKeys("AINABEKN");
        Selenide.sleep(3000);
        driver.findElementByXPath("/html/body/div[2]/div[1]/div/form/div[2]/div[1]/div/ul[1]/ul/li[2]/input").sendKeys("143");
        Selenide.sleep(3000);
        driver.findElementByXPath("/html/body/div[2]/div[1]/div/form/div[2]/div[1]/div/ul[1]/li/input").sendKeys("NURGUL");
        Selenide.sleep(3000);
        ...
        Selenide.sleep(1000);
        driver.findElementByXPath("/html/body/div[2]/div[1]/div/form/div[2]/div[1]/div/ul[3]/li[3]/input").sendKeys("2");
        Selenide.sleep(3000);
